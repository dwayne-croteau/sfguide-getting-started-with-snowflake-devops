...
CREATE WAREHOUSE IF NOT EXISTS QUICKSTART_WH WAREHOUSE_SIZE = XSMALL, AUTO_SUSPEND = 60, AUTO_RESUME= TRUE;
...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/dwayne-croteau') -- INSERT YOUR GITHUB USERNAME HERE
  ENABLED = TRUE;
